      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        ...
        <section className="mb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <a
              href="#"
              className="rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-900 transition"
            >
              Edificios
            </a>
            <a
        ...
        <section>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <p className="text-sm text-gray-500 dark:text-gray-400">Rentas cobradas (mes)</p>
              <p className="mt-2 text-2xl font-semibold">$245,320</p>
              <p className="mt-1 text-xs text-emerald-600 dark:text-emerald-400">+8.2% vs. mes anterior</p>
            </div>
            <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <p className="text-sm text-gray-500 dark:text-gray-400">Tickets abiertos</p>
              <p className="mt-2 text-2xl font-semibold">23</p>
              <p className="mt-1 text-xs text-red-600 dark:text-red-400">+3 nuevos hoy</p>
            </div>
            <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <p className="text-sm text-gray-500 dark:text-gray-400">Pagos pendientes</p>
              <p className="mt-2 text-2xl font-semibold">41</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Vencen esta semana</p>
            </div>
            <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <p className="text-sm text-gray-500 dark:text-gray-400">Notificaciones programadas</p>
              <p className="mt-2 text-2xl font-semibold">8</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Por edificio</p>
            </div>
          </div>
        </section>
